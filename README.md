...
| [random_id.default_statement_id](https://registry.terraform.io/providers/hashicorp/random/latest/docs/resources/id) | resource |
...
| <a name="input_enable_archive_policy"></a> [enable\_archive\_policy](#input\_enable\_archive\_policy) | Determines if the archive policy should be enabled for the SNS topic. | `bool` | `false` | no |
| <a name="input_enable_data_protection_policy"></a> [enable\_data\_protection\_policy](#input\_enable\_data\_protection\_policy) | Determines if the data protection policy should be enabled for the SNS topic. | `bool` | `false` | no |
| <a name="input_enable_default_topic_policy"></a> [enable\_default\_topic\_policy](#input\_enable\_default\_topic\_policy) | Determines if the default topic policy should be enabled for the SNS topic. | `bool` | `false` | no |
...
| <a name="input_enable_feedback"></a> [enable\_feedback](#input\_enable\_feedback) | Determines if feedback should be enabled for the SNS topic. | `bool` | `false` | no |
...
| <a name="output_topic_beginning_archive_time"></a> [topic\_beginning\_archive\_time](#output\_topic\_beginning\_archive\_time) | The oldest timestamp at which a FIFO topic subscriber can start a replay. Relevant only for FIFO topics. |
